...
Route::get('/get-insciptions-cetec-approveds-excel/{course_id}', ComboController::class . '@getInscriptionCetecApprovedsExport')->name('getInscriptionCetecApprovedsExport');
